...
if (PinAns.pin === myPin) {
  ...
  if (operationAns.operation === "fast cash") {
    ...
    if (fastCashAns.amount <= myBalance) {
      ...
      console.log(
        chalk.green("Transaction Successful. Your balance is ", Balance2)
      );
    } else {
...
? Enter your pin 1982
Login Successful. Your balance is 11920      
? Please Select an operation withdraw
? Enter the amount you want to withdraw 6000
Remaining Balance: 5920
